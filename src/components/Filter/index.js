  ...
  return (
    <div className={"bg-secondary1 flex-col hidden tablet:flex " + styles.mainblock}>
      ...
      <div className={"flex flex-col " + styles.block}>
        <h2 className="text-h2 mb-3.5 tablet:mb-2.5	">Вид обуви</h2>
        ...
        <h2 className="text-h2 mb-5 mt-6 tablet:mt-3 tablet:mb-2.5">Бренд</h2>
        {Brand.map((item) => (
          <div className="text-p1 mb-2.5">
            <input className={" " + styles.checkbox} type="checkbox" />
            {item}
          </div>
        ))}
        <h2 className="text-h2 my-5 tablet:my-2.5">Пол</h2>
        {Sex.map((item) => (
          <div className="text-p1 mb-2.5">
            <input className={" " + styles.checkbox} type="checkbox" />
            {item}
